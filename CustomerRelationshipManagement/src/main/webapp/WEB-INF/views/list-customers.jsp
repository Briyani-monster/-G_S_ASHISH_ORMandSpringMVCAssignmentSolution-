...
<body>
	...
	<div class="container">
		...
		<h3 class="text-primary mt-5">Customers Lists</h3>
		<hr>
				...
				<c:forEach items="${Customers}" var="tempCust">
					<tr>
						...
						<td class="action" >
							...
							href="/CustomerRelationshipManagement/customer/showFormForUpdate?customerId=${tempCust.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/CustomerRelationshipManagement/customer/delete?customerId=${tempCust.id}"
